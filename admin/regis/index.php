...
<body>
    <?php if (isset($_SESSION["Role"])) {
        ...
        <div class="col-md-12">
            <div class="pull-right">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3>Records: <?php if (isset($_SESSION["countdata"])) {
                                            echo $_SESSION["countdata"] . " รายการ";
                                        } ?></h3>
                                        ...
                                        <td width="36%">
                                            <div align="right">ค้นหา :
                                                <select name="cat" class="input-sm">
                                                    <option value="RegisNO" <?php if (isset($_REQUEST["cat"])) {
                                                                                if ($_REQUEST["cat"] == "RegisNO") {
                                                                                    echo "selected";
                                                                                }
                                                                            } ?>>รหัสผู้ใช้งาน</option>
                                                    <option value="RegisPWD" <?php if (isset($_REQUEST["cat"])) {
                                                                                    if ($_REQUEST["cat"] == "RegisPWD") {
                                                                                        echo "selected";
                                                                                    }
                                                                                } ?>>รหัสผ่าน</option>
                                                    <option value="RegisNaID" <?php if (isset($_REQUEST["cat"])) {
                                                                                    if ($_REQUEST["cat"] == "RegisNaID") {
                                                                                        echo "selected";
                                                                                    }
                                                                                } ?>>เลขบัตรประชาชน</option>
                                                    <option value="OPTIONS" <?php if (isset($_REQUEST["cat"])) {
                                                                                if ($_REQUEST["cat"] == "OPTIONS") {
                                                                                    echo "selected";
                                                                                }
                                                                            } ?>>ประเภทนักเรียน</option>
                                                    <!-- <option value="RegisStatus"<?php if (isset($_REQUEST["cat"])) {
                                                                                        if ($_REQUEST["cat"] == "RegisStatus") {
                                                                                            echo "selected";
                                                                                        }
                                                                                    } ?>
    ...
    <option value="TYPE"<?php if (isset($_REQUEST["cat"])) {
                            if ($_REQUEST["cat"] == "TYPE") {
                                echo "selected";
                            }
                        } ?>
     >ระดับชั้น</option>
<option value="TYPESuccess"<?php if (isset($_REQUEST["cat"])) {
                                if ($_REQUEST["cat"] == "TYPESuccess") {
                                    echo "selected";
                                }
                            } ?>
     >ระดับชั้นที่สมัครเสร็จสิ้น</option>
<option value="TYPE21"<?php if (isset($_REQUEST["cat"])) {
                            if ($_REQUEST["cat"] == "TYPE22") {
                                echo "selected";
                            }
                        } ?>
     >22 : ระดับชั้นที่สมัครเสร็จสิ้น</option>
<option value="TYPE22"<?php if (isset($_REQUEST["cat"])) {
                            if ($_REQUEST["cat"] == "TYPE23") {
                                echo "selected";
                            }
                        } ?>
     >23 : ระดับชั้นที่สมัครเสร็จสิ้น</option>
<option value="TYPE23"<?php if (isset($_REQUEST["cat"])) {
                            if ($_REQUEST["cat"] == "TYPE25") {
                                echo "selected";
                            }
                        } ?>
     >25 : ระดับชั้นที่สมัครเสร็จสิ้น</option>
<option value="TYPE24"<?php if (isset($_REQUEST["cat"])) {
                            if ($_REQUEST["cat"] == "TYPE26") {
                                echo "selected";
                            }
                        } ?>
     >26 : ระดับชั้นที่สมัครเสร็จสิ้น</option>
<option value="TYPE25"<?php if (isset($_REQUEST["cat"])) {
                            if ($_REQUEST["cat"] == "TYPE27") {
                                echo "selected";
                            }
                        } ?>
     >27 : ระดับชั้นที่สมัครเสร็จสิ้น</option>
     <option value="DAYCOME"<?php if (isset($_REQUEST["cat"])) {
                                if ($_REQUEST["cat"] == "DAYCOME") {
                                    echo "selected";
                                }
                            } ?>
     >วันที่มายื่นเอกสาร</option> -->
                                        ...
                                        <td width="64%">
                                            ...
                                            <input name="Search" type="text" class="input-sm" value="<?php if (isset($_REQUEST["Search"])) echo $_REQUEST["Search"]; ?>">
                                            ...
                                            <a class="btn btn-default" <?php if (isset($_SESSION["cat"])) {
                                                                            echo "href=\"index.php?btnAll=yes\"";
                                                                        } else {
                                                                            echo "href=\"\"";
                                                                        }
                                                                        ?>>ทั้งหมด</a>
                                            ...
                                            <a class="btn btn-default" href="index.php?le=1&op=ส่งเอกสารแล้ว"> ม.1 ส่งเอกสารแล้ว</a>
                                            <p>&nbsp;</p>
                            ...
                            <!-- <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $query_img = mysqli_query($mysqli, $sql_img) or die("Error Query");
                                        $count = mysqli_num_rows($query_img);

                                        if ($count > 0) {


                                            $i = 1;
                                            while ($result_img = mysqli_fetch_assoc($query_img)) { ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
